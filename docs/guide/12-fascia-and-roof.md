---
page: P12
title: Fascia, rake boards and the roofing note
stage: Stage 9 of 12
prev: 11-rafters.md
next: 13-skirt-and-siding.md
---
...
![Fig 12.1 — Section through the front eave, viewed from the left gable end, Stage 9. The fascia stands tight against the plumb rafter tails with its top flush with the tail tops; the rafter's front birdsmouth sits on the front plate just inboard.](figures/fig-12-eave-section.svg)
...
![Fig 12.2 — Roof plan, looking down, Stage 9. Front and back fascia cap every rafter tail, 12" past each side wall; the rake boards run down the gable edges between them. The rafters below are already built (grey); the fascia and rake boards are the new work (colour).](figures/fig-12-roof-plan.svg)
