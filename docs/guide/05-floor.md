---
page: P05
title: Floor framing and deck
stage: Stage 2 of 12
prev: 04-blocks-and-skids.md
next: 06-front-wall.md
---

# Stage 2 — Floor framing and deck
...
in Stage 1. Fasteners are not modeled and are not on either lumber order: nail sizes and counts
are your call as the builder (typical floor framing practice applies).

## Before you start

Parts tick-off (from the framing order, [P02](02-order-framing.md)):
...
Tools: tape, speed square, chalk line, circular saw (for the OSB rip), drill/driver or hammer,
a straight 2×4 or level long enough to span several joists.

## Steps

### 1. Nail the two rim joists along the skid outsides

Set each 16' 2×6 rim flat-side out along the outside face of its skid — the front rim along the
front (street) skid, the back rim along the back skid — with the rim's bottom bearing on the skid
top and its ends flush with the skid ends. Nail the rims to the skids. The rims' outside faces
define the front and back edges of the deck.

### 2. Mark the joist layout on both rims

Hook your tape on the left-end mark and mark the **left edge of every joist** on the inside face
of both rims — front and back get identical marks:

| Joist | Tape reading | Note |
|---|---|---|
| 1 | 0" | flush with the left end |
| 2 | 14½" | |
| 3 | 30½" | |
| 4 | 46½" | |
| 5 | 62½" | |
| 6 | 78½" | |
| 7 | 94½" | doubled pair — first |
| 8 | 96" | doubled pair — second |
| 9 | 112" | |
| 10 | 128" | |
| 11 | 144" | |
| 12 | 160" | |
| 13 | 176" | |
| 14 | 190½" | flush with the right end |

The field spacing is 16" on centre, run in from each end; the doubled pair at 94½"/96" closes the
middle.

![Fig 5.1 — Floor framing in plan view, looking straight down from above the deck, FRONT (street side) at top. Stage 2: the two rims and 14 joists in full colour, the Stage 1 skids grey beneath them, and the four deck sheets dashed with their seams at 48", 96", and 144" from the left end. The tape readings along the bottom edge are the layout marks.](figures/fig-05-a.svg)
...
your OSB wants edge support there (blocking or edge clips), add it — that support is not modeled
and not on the order. Nail the sheets off as you go.

### 6. Make the deck top your zero
...
- [ ] Rim bottoms bearing hard on the skid tops, no gaps — checked by sighting along each rim
- [ ] Field joists at 16" on centre, doubled pair at 94½"/96" — checked with a tape
- [ ] All three deck seams landing on joists, the middle one split over the doubled pair — checked by eye and tap
- [ ] Deck flat across its width — checked with a straightedge or level over several joists
- [ ] Deck top 9¾" above the skid bottoms — checked with a tape at the skid ends
- [ ] "DECK = 0" penciled on the front rim — checked by eye
